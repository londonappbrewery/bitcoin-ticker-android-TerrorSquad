...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.d(LOG_TAG, "id = " + id);
                final String FINAL_URL = BASE_URL + parent.getItemAtPosition(position);
                Log.d(LOG_TAG, FINAL_URL);
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    final String ask_price = response.getString("ask");
                    updateUI(ask_price);
    ...
    private void updateUI(String ask_price) {
        this.mPriceTextView.setText(ask_price);
    }
